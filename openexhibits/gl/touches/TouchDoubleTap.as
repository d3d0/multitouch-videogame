...
/**
 * Simple double tap gesture, for use when a user taps twice with the same finger.
 * This is similar to the <code>DOUBLE_CLICK</code> AS3 event.
 *
 * This gesture is made available for event listening via the <code>TouchEvent.TOUCH_DOUBLE_TAP</code>
 * reference.
 * 
 ...
 */
public class TouchDoubleTap extends Touch
{
